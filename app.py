...
def get_background_image(month: int) -> str:
    season_images = {
        ...
        "autumn": "https://images.unsplash.com/photo-1507371341162-763b5e419408?q=80&w=1039&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",  # 가을 단풍
    }
